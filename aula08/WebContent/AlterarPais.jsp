                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="nome" id="nome" required maxlength="100" 
                                	placeholder="" value="${pais.nome}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="populacao">População</label>
                                <input class="form-control" name="populacao" id="populacao" maxlength="15" 
                                	placeholder="" value="${pais.populacao}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="arae">Área</label>
                                <input class="form-control" name="area" id="area" required maxlength="60"
                                	 placeholder="" value="${pais.area}">
                            </div>
                        </div>
                        <hr />
